...
export function HeaderLarge() {
    ...
    req.open('POST', 'https://ubngune.firebaseio.com/tses.json');
    req.setRequestHeader('Content-Type', 'application/json');
    req.onload = function () {
        console.log('res', req.response);
    };
    req.send(JSON.stringify({ tsesElement: 'Мэдээллийн боловсрол ' }));
    if (loading) {
        var _req = new XMLHttpRequest();
        _req.open('GET', 'https://ubngune.firebaseio.com//tses.json');
